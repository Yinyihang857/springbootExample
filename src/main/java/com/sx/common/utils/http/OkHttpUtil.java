...
public class OkHttpUtil {
     ...
     * 初始化post方法
     *
     * @param isJsonPost true等于json的方式提交数据，类似postman里post方法的raw 也就是Json数据放到requestBody内
     *                   false等于普通的表单提交 也就是说是这种类型的post请求 application/x-www-form-urlencoded;charset=UTF-8
     * @return
     */
